        ...
        while(winner == null){
            ...
            if(gb.checkWinner() == null){
                ...
                do{
                    ...
                    System.out.println("Bot selects "+botPos);
                    for(int i=0; i<3; i++){
                        for(int j=0; j<3; j++){
...
class Game {
    ...
    public static String checkWinner(){
        ...
        //357
        else if(gameboard[0][2] == gameboard[1][1] && gameboard[1][1] == gameboard[2][0]){ winning_user = gameboard[0][2]; }
